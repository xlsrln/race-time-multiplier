...
const PredictionResult: React.FC<PredictionResultProps> = ({
  ...
  const renderPredictionSection = (title: string, data: PredictionResultData, isPrimary: boolean = false) => (
  ...
  return (
    <div className="mt-6 space-y-4">
      {renderPredictionSection("Prediction based on average times", avg, true)}
